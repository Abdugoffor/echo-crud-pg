...
func main() {
	...
	chrome := sharedutil.MustValue(chromium.New())
	defer chrome.Close()

	l.Println(sharedutil.MustValue(chrome.Run(f, html)))
...
<body>
  ...
  <header>
    <h1>Joe McFadden</h1>
    <div>
      <h2>Digital Strategist &amp; Marketing</h2>
  ...
  <aside>
    ...
    -->
	<img src="https://images.unsplash.com/photo-1583195764036-6dc248ac07d9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2376&q=80" alt="">
    <span class="img">
      <img src="https://images.unsplash.com/photo-1583195764036-6dc248ac07d9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2376&q=80" alt="">
    </span>
    <hr />
